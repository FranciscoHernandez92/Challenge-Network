...
import { HttpError } from '../../middlewares/errors.middlewares.js';
import { type PrismaClient } from '@prisma/client';
import { type User, type UserCreateDto } from '../../entities/users.entities';

const debug = createDebug('W7:repository');
